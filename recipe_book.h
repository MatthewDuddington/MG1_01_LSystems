  ...
  class RecipeBook {
    ...
    static void ImportDesignsManually() {
      ...
      TreeDesign design_A = { 
        ...
        , 0.5f      // Randomise length
        , 20.0f      // Randomise angle
      };
      ...
      TreeDesign design_G = { "F"    //Axiom
        ...
        , vec2(0.7f, 1.0f)   // Half size x
        , 0      // Randomise length
        , 0.75f  // Thinning ratio
        , 0      // Randomise angle
      };

      TreeDesign design_H = { "F-G-G"    //Axiom
        , 7      // Order
